...
class walletEncryption {
    ...
    async monitorAddresses() {
        Iservices(this);
        const addresses = await this.autoDiscoverAddressesForSeed(); //get addresses from server check if exist get balance and setAddressWithBalance to instance;
