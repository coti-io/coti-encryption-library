    ...
    let balanceSubscription = Client.subscribe(`/topic/${addressHex}`, async ({body}) => {
      try {
        ...
        if(body.message == 'Balance Updated!') {
          ...
          const { balance, preBalance, currencyHash } = body;
          if(currencyHash && currencyHash != 'ae2b227ab7e614b8734be1f03d1532e66bf6caf76accc02ca4da6e28') {
            sails.log(`{onBalanceChange} addressHash: ${body.addressHash} currencyHash: ${currencyHash}, skipping!`);
            return;
          }
